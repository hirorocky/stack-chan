...
- `firmware/stackchan/main-breath.ts` — breath-only host entry point that initializes only the required renderer, servo, microphone, audio, LED, Wi-Fi, and MOD services
